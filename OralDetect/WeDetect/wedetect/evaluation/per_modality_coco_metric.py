...
Scoring matches OralDetect/tools/per_modality_eval.py exactly: COCOeval restricted to each
    ...
    def compute_metrics(self, results):
        ...
        if missing:
            raise ValueError(
                ...
                f'First few: {missing[:3]}. Run OralDetect/tools/fix_modality_field.py --apply.')
