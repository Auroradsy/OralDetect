"""Build a WeDetect init checkpoint with OralCLIP-v11's dental-CLIP-trained ConvNeXt
...
convnext), only the OralCLIP checkpoint (v11 instead of v8) and the extra text-drop step
...
OC = "/ihome/lzhan/sid51/projects/VLM/OralDetect-Family/OralCLIP/ckpts/clip_checkpoints_v11/best.pt"
OUT = "/ihome/lzhan/sid51/projects/VLM/OralDetect-Family/pretrained_models/wedetect_oralclipv11_dentalbert_init.pth"
